...
Type `edge://extensions` in url search bar, it will redirect to the main page of Installed Edge add-ons
...
Then open the folder containing a child `manifest.json` (here, open `C:\Users\userJay30\AppData\Local\Microsoft\Edge\workspace\Extensions\bdbdcppgiiidaolmadifdlceedoojpfh\1.0.5_0` folder)
